...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file$1, 16, 6, 328);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "id", "name");
    			add_location(input0, file$1, 17, 6, 365);
    			attr_dev(div0, "class", "form-control");
    			add_location(div0, file$1, 15, 4, 295);
    			attr_dev(label1, "for", "amount");
    			add_location(label1, file$1, 20, 6, 463);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "id", "amount");
    			add_location(input1, file$1, 21, 6, 504);
    			attr_dev(div1, "class", "form-control");
    			add_location(div1, file$1, 19, 4, 430);
    			attr_dev(button0, "type", "submit");
    			attr_dev(button0, "class", "btn btn-block");
    			button0.disabled = /*isEmpty*/ ctx[2];
    			toggle_class(button0, "disabled", /*isEmpty*/ ctx[2]);
    			add_location(button0, file$1, 26, 4, 658);
    			attr_dev(i, "class", "fas fa-times");
    			add_location(i, file$1, 30, 6, 830);
    			attr_dev(button1, "type", "button");
    			attr_dev(button1, "class", "close-btn");
    			add_location(button1, file$1, 29, 4, 783);
    			attr_dev(form, "class", "expense-form");
    			add_location(form, file$1, 14, 2, 263);
    			attr_dev(section, "class", "form");
    			add_location(section, file$1, 12, 0, 206);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Title, name, amount, isEmpty });
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 30, 2, 779);
    			attr_dev(main, "class", "content");
    			add_location(main, file, 26, 0, 664);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
